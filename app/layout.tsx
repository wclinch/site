...
const DESCRIPTION = 'A local-first, source-native workspace for reading and writing. PDFs, images, and web pages alongside the project work. One window, on the device. No account. No cloud.'
